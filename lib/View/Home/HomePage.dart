...
import 'package:ilearn/Repository/ApiService.dart';
import 'package:ilearn/RxDart/ChoiceFilesOrViedo.dart';
import 'package:ilearn/RxDart/HomeListFilesAndVideo.dart';
import 'package:ilearn/RxDart/MyAppBottomNavigation.dart';
import 'package:ilearn/View/Home/selected_book_screen.dart';
import 'package:ilearn/View/Home/youtubeDetails.dart';
import 'package:ilearn/View/MyApp/MyApp.dart';
import 'package:ilearn/View/News/News.dart';
import 'package:ilearn/View/Search/Search.dart';
                ...
                Container(
                  ...
                  child: StreamBuilder<int>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.data == 0)
                          return Container(
                            child: StreamBuilder<List<NewBookModel>>(
                                stream: homeListFilesAndVideo.observableObject,
                                builder: (context, snapshot) {
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(context, PageTransition(type: PageTransitionType.fadeIn, alignment: Alignment.center, duration: Duration(milliseconds: 400), child: NewsScreen()));
                        },
                        child: Container(
